...
graph_tool_partition = gt.minimize_blockmodel_dl(input_graph, mcmc_args={'parallel':False}, mcmc_equilibrate_args={'verbose':False, 'epsilon':1e-4}, mcmc_multilevel_args={'r':2}, verbose=True)
